...
- Final assistant responses in the TUI use a lightweight Markdown-lite renderer: headings, bullets, simple bold/inline code cleanup, and simple `a^2 -> a²` normalization are supported, but this is not full Markdown or LaTeX rendering.
